...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   let callback = function(elemento) {elemento.esPremium = true; }
   objetoMuchosUsuarios.forEach(callback);
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var acumulador = 0;
   let cb = function(post) {
      acumulador = acumulador + post.likes;
   }
   objetoUsuario.posts.forEach(cb);
   return acumulador;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = cb;
